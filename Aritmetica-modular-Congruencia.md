Este documento constituye un cuerpo de conocimiento estructurado sobre la aritmética modular y la teoría de congruencias, analizado desde una perspectiva formal y algorítmica basada en las fuentes proporcionadas.
...
- **Ejercicio 5.1:** Resolver el sistema de dos ecuaciones: $$\begin{cases} x \equiv 1 \pmod{2} \ x \equiv 2 \pmod{3} \end{cases}$$
- **Ejercicio 5.2:** Resolver el sistema: $$\begin{cases} x \equiv 2 \pmod{3} \ x \equiv 1 \pmod{5} \end{cases}$$
